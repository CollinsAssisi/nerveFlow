...
\begin{figure}
\includegraphics[scale=0.7]{Bench.pdf} 
...
\caption{\textbf{Euler's method} The dashed line shows the solution computed by successive iterations of Euler's method. It diverges from the actual solution as errors accumulate over time. }
\label{fig:euler}
\end{figure}
...
\begin{center}
\begin{figure}
\includegraphics[scale=0.4]{fig13.pdf} 
